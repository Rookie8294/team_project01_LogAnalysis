...
public class LoginEvt extends WindowAdapter implements ActionListener {
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (loginView.getJbtnLogin() == ae.getSource() || ae.getSource() == loginView.getJtfPw()) {
			String pw = String.valueOf(loginView.getJtfPw().getPassword());
